...
if "current_user" not in st.session_state:
    st.session_state.current_user = {"full_name": "Admin", "role": "admin"}
...
<style>
    ...
    /* Input fields - force white background with black text */
    ...
    /* Expander */
    [data-testid="stExpander"] { background-color: #f9f9f9 !important; border: 1px solid #e0e0e0 !important; }
    ...
    [data-baseweb="tab"] { color: #444444 !important; background-color: #ffffff !important; }
    [aria-selected="true"] { color: #000000 !important; border-bottom: 2px solid #FFD000 !important; }

    /* Dataframe / table */
    [data-testid="stDataFrame"] { background-color: #ffffff !important; color: #000000 !important; }
    .stDataFrame th { background-color: #f2f2f2 !important; color: #000000 !important; }
    .stDataFrame td { background-color: #ffffff !important; color: #000000 !important; }

    /* Metric cards */
    [data-testid="stMetric"] { background-color: #f8f9fa !important; padding: 15px; border-radius: 10px; border-left: 5px solid #FFD000; }
    [data-testid="stMetricValue"] { color: #000000 !important; font-size: 24px; }
    [data-testid="stMetricLabel"] { color: #444444 !important; }
    [data-testid="stMetricDelta"] { color: #444444 !important; }

    /* Containers / cards */
    [data-testid="stVerticalBlockBorderWrapper"] { background-color: #ffffff !important; border: 1px solid #e0e0e0 !important; border-radius: 8px; }
    ...
    /* Code blocks */
    code, pre, [data-testid="stCode"] { background-color: #f4f4f4 !important; color: #000000 !important; }

    /* Progress bar */
    [data-testid="stProgress"] > div { background-color: #FFD000 !important; }
    ...
    /* Markdown text */
    .stMarkdown, .stMarkdown p, .stMarkdown span { color: #000000 !important; }
    ...
    /* Link buttons */
    a[data-testid="stLinkButton"] { color: #000000 !important; }
    ...
    small, .caption { color: #555555 !important; }

    /* Number input */
    [data-testid="stNumberInput"] input { background-color: #ffffff !important; color: #000000 !important; }

    /* File uploader */
    [data-testid="stFileUploader"] { background-color: #f9f9f9 !important; color: #000000 !important; }
    ...
    /* Toast */
    [data-testid="stToast"] { background-color: #ffffff !important; color: #000000 !important; }
</style>
""",
